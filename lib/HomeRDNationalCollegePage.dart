...
class HomeRDNationalCollegePage extends StatefulWidget {
  const HomeRDNationalCollegePage({Key? key}) : super(key: key);

  @override
  _HomeRDNationalCollegePageState createState() =>
      _HomeRDNationalCollegePageState();
}

class _HomeRDNationalCollegePageState
    extends State<HomeRDNationalCollegePage> {
  int _currentIndex = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('RD National college Home'),
