...
class HomeHRCollegePage extends StatefulWidget {
  const HomeHRCollegePage({Key? key}) : super(key: key);

  @override
  _HomeHRCollegePageState createState() =>
      _HomeHRCollegePageState();
}

class _HomeHRCollegePageState
    extends State<HomeHRCollegePage> {
  int _currentIndex = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('HRCollege Home'),
