...
class HomeMithibaiCollegePage extends StatefulWidget {
  const HomeMithibaiCollegePage({Key? key}) : super(key: key);

  @override
  _HomeMithibaiCollegePageState createState() =>
      _HomeMithibaiCollegePageState();
}

class _HomeMithibaiCollegePageState
    extends State<HomeMithibaiCollegePage> {
  int _currentIndex = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('MithibaiCollege Home'),
