...
class HomeWilsonCollegePage extends StatefulWidget {
  const HomeWilsonCollegePage({Key? key}) : super(key: key);

  @override
  _HomeWilsonCollegePageState createState() =>
      _HomeWilsonCollegePageState();
}

class _HomeWilsonCollegePageState
    extends State<HomeWilsonCollegePage> {
  int _currentIndex = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Wilson College Home'),
...
class CustomFAB extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FloatingActionButton(
      onPressed: onPressed,
      child: Image.asset('assets/wilson.png'), // Assuming the logo is in the 'assets' folder
