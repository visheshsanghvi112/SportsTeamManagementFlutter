...
class HomeKishinchandChellaramPage extends StatefulWidget {
  const HomeKishinchandChellaramPage({Key? key}) : super(key: key);

  @override
  _HomeKishinchandChellaramPageState createState() =>
      _HomeKishinchandChellaramPageState();
}

class _HomeKishinchandChellaramPageState
    extends State<HomeKishinchandChellaramPage> {
  int _currentIndex = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Kishinchand Chellaram College Home'),
