...
class HomeElphinstoneCollegePage extends StatefulWidget {
  const HomeElphinstoneCollegePage({Key? key}) : super(key: key);

  @override
  _HomeElphinstoneCollegePageState createState() =>
      _HomeElphinstoneCollegePageState();
}

class _HomeElphinstoneCollegePageState
    extends State<HomeElphinstoneCollegePage> {
  int _currentIndex = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('ElphinstoneCollege Home'),
